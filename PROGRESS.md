...
| **배포** | Frontend: Vercel (icn1), Backend: Render.com (Docker) |
| **저장소** | GitHub: https://github.com/SONGMINSEUNG/place.git |
...
│   │   │       ├── activity.py   # 활동 로그
│   │   │       ├── train.py      # 학습
│   │   │       └── parameters.py # 파라미터 관리
│   │   ├── services/         # 비즈니스 로직
│   │   │   ├── naver_place.py       # 네이버 크롤링 (96KB)
│   │   │   ├── adlog_proxy.py       # ADLOG API 프록시
│   │   │   ├── scheduler.py         # 스케줄러
│   │   │   ├── formula_calculator.py # 자체 계산
│   │   │   └── parameter_extractor.py # 파라미터 추출
│   │   ├── ml/               # 머신러닝
│   │   │   ├── predictor.py           # N1/N2/N3 예측
│   │   │   ├── trainer.py             # 키워드 학습
│   │   │   ├── analyzer.py            # 정확도 분석
...
| Phase | 기능 | 상태 | 점수 |
|-------|------|------|------|
| Phase 1 | 키워드 파라미터 시스템 | ✅ 완료 | 89점 |
| Phase 2 | 새벽 자동 학습 시스템 | ✅ 완료 | 89점 |
| Phase 3 | 시뮬레이션 개선 | ✅ 완료 | 88점 |
| Phase 4 | 시계열 학습 | ✅ 완료 | 82점 |

### Git 상태
- 현재 브랜치: `main`
- 상태: PROGRESS.md 수정됨 (미커밋)
- 최근 커밋: `5f10ff3` - Config: 배포 설정 파일 업데이트
